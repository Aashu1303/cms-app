...
class _OrdersAdminWidgetState extends State<OrdersAdminWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'orders-Admin'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ORDERS_ADMIN_orders-Admin_ON_INIT_STATE');
      logFirebaseEvent('orders-Admin_update_app_state');
            ...
            child: Scaffold(
              ...
              floatingActionButton: Padding(
                ...
                child: FloatingActionButton(
                  onPressed: () async {
                    logFirebaseEvent(
                        'ORDERS_ADMIN_FloatingActionButton_s28eg0');
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('ORDERS_ADMIN_PAGE_listContainer_ON_TAP');
                                                                                          ...
                                                                                          RichText(
                                                                                            ...
                                                                                            text: TextSpan(
                                                                                              children: [
                                                                                                ...
                                                                                                TextSpan(
                                                                                                  text: todayListItem.orderNumber.toString(),
                                                                                                  style: TextStyle(
                                                                                              ...
                                                                                              RichText(
                                                                                                ...
                                                                                                text: TextSpan(
                                                                                                  children: [
                                                                                                    ...
                                                                                                    TextSpan(
                                                                                                      text: listViewOrdersRecord.orderNumber.toString(),
                                                                                                      style: TextStyle(
                                                                                                        color: FlutterFlowTheme.of(context).primary,
                                                                                                        fontWeight: FontWeight.bold,
                                                                                                        fontSize: 15.0,
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORDERS_ADMIN_PAGE_Icon_micaf3pt_ON_TAP');
                                                                logFirebaseEvent(
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              (groupOrdersItem.order.isNotEmpty) == true ? groupOrdersItem.type : '  ',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'Plus Jakarta Sans',
                                                                                    letterSpacing: 0.0,
                                                                                  ),
                                                                                                        ...
                                                                                                        RichText(
                                                                                                          ...
                                                                                                          text: TextSpan(
                                                                                                            children: [
                                                                                                              ...
                                                                                                              TextSpan(
                                                                                                                text: listContainerOrdersRecord.orderNumber.toString(),
                                                                                                                style: TextStyle(
                                                                                                                  color: FlutterFlowTheme.of(context).primary,
                                                                                                                ),
                                                                                                              )
