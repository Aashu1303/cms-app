...
class UserItemsAdminWidget extends StatefulWidget {
  const UserItemsAdminWidget({
    super.key,
  ...
  @override
  State<UserItemsAdminWidget> createState() => _UserItemsAdminWidgetState();
}

class _UserItemsAdminWidgetState extends State<UserItemsAdminWidget> {
  late UserItemsAdminModel _model;
      ...
      body: SafeArea(
        ...
        child: Align(
          ...
          child: StreamBuilder<OrdersRecord>(
            stream: OrdersRecord.getDocument(widget.orderID!),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: columnOrdersRecord.status,
                                  style: const TextStyle(
                                    fontSize: 20.0,
                                  ),
                                )
                          ...
                          if ((columnOrdersRecord.status == 'Accepted') &&
                              (columnOrdersRecord.service != 'Completed'))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 20.0, 0.0, 0.0),
                              child: FFButtonWidget(
